...
void setupShape(unsigned int shaderProgram, std::vector<float>vertexData, unsigned int &VBO, unsigned int &VAO, unsigned int &vertexCount);
...
void processInput(GLFWwindow *window, double *xOut, double *yOut);
...
int main()
{
    ...
    setupShape(shaderProgram, vertices, VBO, VAO, vertexCount);
...
// -------------------------------------------------------------------------------------------------------
void setupShape(const unsigned int shaderProgram, std::vector<float>vertexData, unsigned int &VBO, unsigned int &VAO, unsigned int &vertexCount){
    createArrayBuffer(vertexData, VBO);

    // tell how many vertices to draw
    vertexCount = vertexData.size() / 5;
    ...
    glVertexAttribPointer(posAttributeLocation, posSize, GL_FLOAT, GL_FALSE, 5*sizeof(GLfloat), 0);
    ...
    glVertexAttribPointer(colorAttributeLocation, colorSize, GL_FLOAT, GL_FALSE, 5*sizeof(GLfloat), (GLvoid*) (2*sizeof(GLfloat)));
}
