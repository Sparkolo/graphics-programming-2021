...
void main()
{
   ...
   vec3 N = texture(texture_normal1, fs_in.textCoord).xyz * 2.0 - vec3(1.0);
   ...
   vec3 reflectDir = reflect(fs_in.Pos_tangent - fs_in.CamPos_tangent, N);
   vec3 reflectionColor = texture(skybox, fs_in.invTBN * reflectDir).rgb;
