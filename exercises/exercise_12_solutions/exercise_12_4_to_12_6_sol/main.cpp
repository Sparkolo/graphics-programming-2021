...
int main()
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB16F, glfw_width, glfw_height, 0, GL_RGB, GL_FLOAT, NULL);
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, glfw_width, glfw_height, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT, glfw_width, glfw_height);
